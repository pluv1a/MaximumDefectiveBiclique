...
public:
    ...
    CliqueEnum(int k, int lbv, int alg=5);
    CliqueEnum(int k, int lbv[2], int lbe=0, int alg=5);
    CliqueEnum();
    ~CliqueEnum();
    void run();
    ...
    vector<int> mdb;
    int32 MBicliqueSize  = 0;
    int32 numBranches = 0;
};

class MDC : public MDB {
public:
